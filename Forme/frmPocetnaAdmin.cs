...
namespace OnlineFanShop
{
    public partial class frmPocetnaAdmin : Form
    {
        ...
        public frmPocetnaAdmin(string korisnickoIme, int iD_korisnik)
        {
            InitializeComponent();
        ...
        private void dgvPonuda_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void btnUpravljanjePonudom_Click(object sender, EventArgs e)
        {
            frmUpravljanjePonudom form = new frmUpravljanjePonudom();
            form.ShowDialog();
        }
        ...
        private void btnUrediProizvod_Click(object sender, EventArgs e)
        {
            PopisPonude selektiranaPonuda = dgvPonuda.CurrentRow.DataBoundItem as PopisPonude;
            int id_korisnik = ID_korisnik;
            frmUrediOdabranuPonudu form = new frmUrediOdabranuPonudu(selektiranaPonuda, id_korisnik);
            form.ShowDialog();
            OsvjeziPopisPonude();
        }
    }
